...
if __name__ == "__main__":
    ...
    parser.add_argument('--tasa_mutacion_individuo', type=float, default=0.1, help='Probabilidad de mutación del individuo')
    parser.add_argument('--tasa_mutacion_gen', type=float, default=0.05, help='Probabilidad de mutación del gen')
    parser.add_argument('--generaciones', type=int, default=50, help='Número de generaciones')
